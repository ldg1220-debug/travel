            ...
            visibleNotifications.map((n) => (
              ...
              >
                {n.type === "announcement" ? (
                  ...
                  <span className="flex h-8 w-8 shrink-0 items-center justify-center overflow-hidden rounded-full bg-gradient-to-br from-brand-600 to-brand-pink-600 text-xs font-bold text-white">
                    {n.actorImage ? (
                ...
                <span className="min-w-0 flex-1">
                  ...
                  {n.type === "follow_request" && n.requestStatus === "pending" && (
                    <span className="mt-1.5 flex gap-1.5">
                      <span
                        ...
                        className={`rounded-full bg-brand-700 px-3 py-1 text-[11px] font-semibold text-white transition-opacity hover:bg-brand-800 ${
                  ...
                  {n.type === "follow_request" && n.requestStatus === "accepted" && (
                    <span className="mt-1 block text-[11px] font-semibold text-brand-600">수락함</span>
                  )}
                </span>
              </button>
            ))
