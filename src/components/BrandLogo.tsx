...
export function BrandLogo({
  ...
  imgClassName?: string;
  alt?: string;
  /** "dark" = black line-art logo (for light backgrounds, default); "light" = white logo (for dark backgrounds). */
  variant?: "dark" | "light";
}) {
  ...
  const src = variant === "light" ? "/brand/tradule-logo-white.png" : "/brand/tradule-logo.png";
  return (
    ...
    <img src={src} alt={alt} loading="eager" fetchPriority="high" onError={() => setFailed(true)} className={imgClassName} />
  );
}
