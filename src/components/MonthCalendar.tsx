...
/**
 * Small month-grid date picker (Notion/Google Calendar style) — replaces the
 * old horizontal "next 14 days" chip strip so any date, past or future
 * month, is reachable via the ‹ › month nav instead of only a two-week window.
 */
